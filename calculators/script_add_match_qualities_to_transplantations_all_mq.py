...
if __name__ == '__main__':
    ...
    df_mq = pd.DataFrame.from_records(
        ...
        hla_system.determine_mismatches(d=d, p=p, safely=False)
    ...
    df_with_mq.to_csv('data/Klundert/transplantations_with_mq_vpra.csv', index=False)
    df_with_mq.to_csv('X:/PRJ/Machine learning/afd/Hans_de_Ferrante/ETKAS/ETKAS_effect_mm_revised/data/transplantations_with_mq_vpra.csv')
